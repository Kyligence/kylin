...
import org.apache.spark.sql.execution.datasources.{BucketingUtils, CacheFilePartition, CacheFileScanRDD, DataSourceStrategy, DataSourceUtils, FilePartition, FileScanRDD, HadoopFsRelation, PartitionDirectory, PartitionedFile}
...
case class KylinStorageScanExec(
    ...
    disableBucketedScan: Boolean = false) extends DataSourceScanExec {
