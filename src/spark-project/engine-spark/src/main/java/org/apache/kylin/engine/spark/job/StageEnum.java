...
import org.apache.kylin.engine.spark.job.step.SnapshotBuildStage;
...
import org.apache.kylin.engine.spark.job.step.build.IndexPlanStage;
...
public enum StageEnum {
    ...
    TABLE_SAMPLING {
        ...
        @Override
        public StageExec createExec(TableAnalyzeJob job) {
            return new TableAnalyzeStage(Objects.requireNonNull(job));
        }
    ...
    BUILD_SNAPSHOT {
        ...
        @Override
        public StageExec createExec(SnapshotBuildJob job) {
            return new SnapshotBuildStage(Objects.requireNonNull(job));
        }
    ...
    DELETE_USELESS_LAYOUT_DATA {
        ...
        @Override
        public StageExec createExec(LayoutDataOptimizeJob job) {
            return new LayoutDataVacuumOptimize(Objects.requireNonNull(job));
        }
    ...
    OPTIMIZE_LAYOUT_DATA_BY_REPARTITION {
        ...
        @Override
        public StageExec createExec(LayoutDataOptimizeJob job) {
            return new LayoutDataRepartitionOptimize(Objects.requireNonNull(job));
        }
    ...
    OPTIMIZE_LAYOUT_DATA_BY_ZORDER {
        ...
        @Override
        public StageExec createExec(LayoutDataOptimizeJob job) {
            return new LayoutDataZorderOptimize(Objects.requireNonNull(job));
        }
    ...
    OPTIMIZE_LAYOUT_DATA_BY_COMPACTION {
        ...
        @Override
        public StageExec createExec(LayoutDataOptimizeJob job) {
            return new LayoutDataCompactionOptimize(Objects.requireNonNull(job));
        }
    ...
    INTERNAL_TABLE_LOAD {
        ...
        @Override
        public StageExec createExec(InternalTableLoadJob job) {
            return new InternalTableLoad(Objects.requireNonNull(job));
        }
    ...
    OPTIMIZE_INDEX_PLAN {
        ...
        @Override
        public StageExec createExec(IndexPlanOptimizeJob job) {
            return new IndexPlanStage(Objects.requireNonNull(job));
        }
