...
public class CacheFileSystemConstants {
    ...
    public static final String PARAMS_KEY_ACCEPT_CACHE_TIME_FOR_GLUTEN =
        "spark.gluten.sql.columnar.backend.ch.runtime_settings.spark.kylin.local-cache.accept-cache-time";
}
