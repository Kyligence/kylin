...
public class PartitionRowIteratorTest extends StreamingTestCase {
    ...
    public void testTimestampType() {
        ...
        val partitionRowIterator = new PartitionRowIterator(null, schema);
        {
    ...
    public void testDateType() {
        ...
        val partitionRowIterator = new PartitionRowIterator(null, schema);
        {
            Assert.assertThrows("invalid value 1956-01-01", IllegalArgumentException.class,
                    () -> partitionRowIterator.convertJson2Row("{value: \"1956-01-01\"}"));
        }
        {
            Assert.assertThrows("invalid value 1970-01-01", IllegalArgumentException.class,
                    () -> partitionRowIterator.convertJson2Row("{value: \"1970-01-01\"}"));
        }
        {
