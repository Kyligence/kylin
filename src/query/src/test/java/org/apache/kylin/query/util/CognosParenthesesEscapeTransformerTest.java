...
public class CognosParenthesesEscapeTransformerTest extends AbstractTestCase {
    ...
    public void proguardTest() throws IOException {
        CognosParenthesesEscapeTransformer escape = new CognosParenthesesEscapeTransformer();
        Collection<File> files = FileUtils.listFiles(new File("../../../kylin/src/kylin-it/src/test/resources/query"),
                new String[] { "sql" }, true);
        for (File f : files) {
    ...
    public void advanced5Test() throws Exception {
        ...
        String sql2 = FileUtils.readFileToString(
                new File("../../../kylin/src/kylin-it/src/test/resources/query/sql_parentheses_escape/query05.sql"),
                Charset.defaultCharset());
        String expectedSql2 = FileUtils.readFileToString(new File(
                "../../../kylin/src/kylin-it/src/test/resources/query/sql_parentheses_escape/query05.sql.expected"),
                Charset.defaultCharset());
    ...
    public void advanced6Test() throws Exception {
        ...
        String originalSql = FileUtils.readFileToString(
                new File("../../../kylin/src/kylin-it/src/test/resources/query/sql_parentheses_escape/query06.sql"),
                Charset.defaultCharset());
        String expectedSql = FileUtils.readFileToString(new File(
                "../../../kylin/src/kylin-it/src/test/resources/query/sql_parentheses_escape/query06.sql.expected"),
                Charset.defaultCharset());
        originalSql = QueryUtil.removeCommentInSql(originalSql);
