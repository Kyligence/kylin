...
public class SecondStorageIndexResponse {
    ...
    public void initIndexStatus(SecondStorageIndexLoadStatus dataStatus) {
        this.secondaryIndexStatus = dataStatus;

        if (dataStatus == SecondStorageIndexLoadStatus.NONE) {
